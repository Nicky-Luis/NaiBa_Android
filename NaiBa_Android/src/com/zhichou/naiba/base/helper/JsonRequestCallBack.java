package com.zhichou.naiba.base.helper;
...
import com.zhichou.naiba.base.utils.HttpCacheUtils;
...
public class JsonRequestCallBack<T> extends RequestCallBack<T> {
	...
	public JsonRequestCallBack(LoadDataHandler<T> handler, T flag) {
		...
		this.flag = flag;
		// this.dbHelper =
		// DBHelper.getInstence(UBabyApplication.application.getApplicationContext());
	}
	...
	public void onFailure(HttpException arg0, String arg1) {
		// TODO Auto-generated method stub
		try {
			// HttpLocalCache localCache =
			// dbHelper.queryHttpLocalCache(absoluteUrl);
			// if (null != localCache) {
			// handler.onSuccess(JSON.parseObject(localCache.getJsonValue()),
			// flag);
			// } else {
