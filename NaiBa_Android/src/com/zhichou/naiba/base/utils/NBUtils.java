...
public class NBUtils {
	...
	@SuppressLint("SimpleDateFormat")
	public static SimpleDateFormat mqttSdf = new SimpleDateFormat(
			"yyyy-MM-dd HH:mm:ss.S");
	@SuppressLint("SimpleDateFormat")
	public static SimpleDateFormat chattingSdf = new SimpleDateFormat(
			"MM-dd HH:mm");
	@SuppressLint("SimpleDateFormat")
	public static SimpleDateFormat chatHistorySdf = new SimpleDateFormat(
			"yyyy-MM-dd HH:mm");
	...
	public static String formatDataChatHistoryList(String dateStr) {
		try {
			...
			try {
				...
				return chatHistorySdf.format(new Date(
	...
	// try {
	// return URLEncoder.encode(Base64.encodeToString(url.getBytes(),
	...
	public static String getPhotoFileName() {
		// 用户id+时间戳
		String fileName = UserManager.getInstance().getUser().getUid() + ""
