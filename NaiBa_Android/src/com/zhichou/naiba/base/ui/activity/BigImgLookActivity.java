...
import com.zhichou.naiba.base.model.ImageModel;
import com.zhichou.naiba.base.ui.view.CustomImageLoadingDialog;
import com.zhichou.naiba.base.ui.view.CustomListViewDialog;
import com.zhichou.naiba.base.ui.view.CustomListViewDialog.ClickCallBack;
import com.zhichou.naiba.base.ui.view.TouchImageView;
...
public class BigImgLookActivity extends BaseActivity {
	...
	private void init() {
		...
		if (intent.hasExtra(INTENT_KEY)) {
			...
			LogUtils.i(imageUrlList.toString());
			imageSubUrlList = imageUrlList;
			if (intent.hasExtra(INTENT_KEY_INDEX)) {
				currentPage = intent.getIntExtra(INTENT_KEY_INDEX, 0);
			} else {
